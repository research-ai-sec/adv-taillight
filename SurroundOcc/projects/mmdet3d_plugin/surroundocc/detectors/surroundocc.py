...
from SurroundOcc.projects.mmdet3d_plugin.models.utils.grid_mask import GridMask
import time
import copy
import numpy as np
import mmdet3d
from SurroundOcc.projects.mmdet3d_plugin.models.utils.bricks import run_time
from SurroundOcc.projects.mmdet3d_plugin.datasets.evaluation_metrics import evaluation_reconstruction, evaluation_semantic
...
class SurroundOcc(MVXTwoStageDetector):
    ...
    def forward(self, img_metas, img,return_loss=True, **kwargs):

        if return_loss:
            return self.forward_train(**kwargs)
        else:
            return self.forward_test(img_metas, img,**kwargs)
