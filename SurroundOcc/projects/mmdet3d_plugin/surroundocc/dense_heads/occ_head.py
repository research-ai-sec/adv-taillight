...
from SurroundOcc.projects.mmdet3d_plugin.surroundocc.loss.loss_utils import multiscale_supervision, geo_scal_loss, sem_scal_loss
...
class OccHead(nn.Module):
    ...
    def forward(self, mlvl_feats, img_metas):
        ...
        volume_embed_org = volume_embed_reshape.copy()
        outputs = []
        ...
        outs = {
            'occ_preds': occ_preds,
            'fpn_3d_outputs': fpn_outputs,
            'vit_outputs': volume_embed_org
        }
